...
from main.views import show_item, create_item, register_account,login_user, logout_user, show_xml, show_json, show_xml_by_id, show_json_by_id, increase_item, decrease_item, delete, get_item_json, add_item_ajax
